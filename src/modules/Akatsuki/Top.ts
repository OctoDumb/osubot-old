    ...
    constructor(module: Module) {
        super(["t", "top"], module, async (ctx, self, args) => {
            ...
            try {
                ...
                if(args.place) {
                    let score = (await self.module.bot.api.akatsuki.getUserTop(dbUser.nickname, dbUser.mode || 0, args.place))[args.place - 1];
                    ...
                    let top = await self.module.bot.api.akatsuki.getUserTop(dbUser.nickname, dbUser.mode || 0, 3);
