...
export default class KurikkuCompare extends Command {
    constructor(module: Module) {
        super(["c", "compare"], module, async (ctx, self, args) => {
            ...
            try {
                ...
                let score = await self.module.bot.api.kurikku.getScore(dbUser.nickname, chat.map.id.map, dbUser.mode || 0, args.mods.length == 0 ? undefined : new Mods(args.mods).sum());
