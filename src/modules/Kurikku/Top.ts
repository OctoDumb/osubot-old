        ...
        super(["t", "top"], module, async (ctx, self, args) => {
            ...
            try {
                ...
                if(args.apx) {
                    ...
                    let score = (await self.module.bot.api.kurikku.getUserTop(dbUser.nickname, dbUser.mode || 0, args.place))[args.place - 1];
                    ...
                    let top = await self.module.bot.api.kurikku.getUserTop(dbUser.nickname, dbUser.mode || 0, 3);
