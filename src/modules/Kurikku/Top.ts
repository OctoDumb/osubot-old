...
export default class KurikkuTop extends Command {
    constructor(module: Module) {
        super(["t", "top"], module, async (ctx, self, args) => {
            ...
            try {
                ...
                if(args.apx) {
                    let top = await self.module.bot.api.kurikku.getUserTop(dbUser.nickname, mode, 100);
                    let nearest = top[0];
                    let place = 1;
                    ...
                    let score = (await self.module.bot.api.kurikku.getUserTop(dbUser.nickname, mode, args.place))[args.place - 1];
                    ...
                    let top = await self.module.bot.api.kurikku.getUserTop(dbUser.nickname, mode, 3);
