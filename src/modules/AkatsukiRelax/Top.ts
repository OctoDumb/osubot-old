    ...
    constructor(module: Module) {
        super(["t", "top"], module, async (ctx, self, args) => {
            ...
            try {
                ...
                if(args.apx) {
                    let top = await self.module.bot.api.relax.getUserTop(dbUser.nickname, dbUser.mode || 0, 100);
                    let nearest = top[0];
                    let place = 1;
                    ...
                    let score = (await self.module.bot.api.relax.getUserTop(dbUser.nickname, dbUser.mode || 0, args.place))[args.place - 1];
                    ...
                    let top = await self.module.bot.api.relax.getUserTop(dbUser.nickname, dbUser.mode || 0, 3);
